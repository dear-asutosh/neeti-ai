...
export default function Settings() {
  ...
  return (
    <div className="p-6 md:p-10 font-sans min-h-screen bg-transparent transition-colors duration-300">
      <div className="max-w-5xl mx-auto space-y-8">
        
        {/* Page Header */}
        <div className="flex items-center gap-4 border-b border-gray-200 dark:border-zinc-800 pb-6">
          <div className="bg-white dark:bg-zinc-900 rounded-xl p-3 shadow-inner border border-gray-200 dark:border-zinc-800">
            <SettingsIcon className="w-8 h-8 text-zinc-900 dark:text-zinc-100" />
          </div>
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Settings & Security</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 overflow-hidden transition-all duration-300 hover:shadow-md hover:border-gray-300 dark:hover:border-zinc-700">
              <div className="p-6 border-b border-gray-100 dark:border-zinc-800/60 bg-gray-50/50 dark:bg-zinc-900/50">
                <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">Profile Details</h3>
              ...
              <div className="p-6 md:p-8 flex flex-col sm:flex-row gap-8 items-start">
                ...
                <div className="flex flex-col items-center space-y-4 shrink-0">
                  <div className="relative group rounded-full overflow-hidden w-36 h-36 border-4 border-gray-100 dark:border-zinc-800 shadow-xl flex items-center justify-center bg-gray-50 dark:bg-zinc-950 transition-transform duration-300 hover:scale-[1.02]">
                    {currentPhotoURL ? (
                  ...
                  <button 
                    onClick={() => fileInputRef.current?.click()}
                    disabled={uploading}
                    className="text-xs font-semibold text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors uppercase tracking-widest disabled:opacity-50"
                  >
                ...
                <div className="flex-1 w-full space-y-5">
                  <div className="space-y-1.5">
                     ...
                     <input 
                       ...
                       className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-950/50 border border-gray-200 dark:border-zinc-800 rounded-lg text-zinc-600 dark:text-zinc-300 font-medium cursor-not-allowed focus:outline-none transition-colors" 
                     />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                     ...
                     <input 
                       ...
                       className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-950/50 border border-gray-200 dark:border-zinc-800 rounded-lg text-zinc-600 dark:text-zinc-300 font-medium capitalize cursor-not-allowed focus:outline-none transition-colors" 
                     />
                  </div>
            ...
            {/* Security Section */}
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 overflow-hidden transition-all duration-300 hover:shadow-md hover:border-gray-300 dark:hover:border-zinc-700 p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
               <div>
          ...
          <div className="space-y-8">
            ...
            {/* System Preferences */}
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 transition-all duration-300 hover:shadow-md hover:border-gray-300 dark:hover:border-zinc-700 p-6 flex flex-col h-[280px]">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 flex items-center gap-2 mb-2">
              ...
              <button disabled className="mt-6 w-full px-4 py-2.5 bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-700 border border-gray-200 dark:border-zinc-700 rounded-lg text-sm font-semibold text-zinc-500 dark:text-zinc-200 transition-colors opacity-50 cursor-not-allowed shadow-sm">
                Configure Alerts
              </button>
            </div>

            {/* Appearance Preferences */}
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 transition-all duration-300 hover:shadow-md hover:border-gray-300 dark:hover:border-zinc-700 p-6">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 flex items-center gap-2 mb-2">
              ...
              <div className="flex gap-3">
                <button 
                  ...
                  className={`flex-1 py-3 rounded-xl text-center cursor-pointer shadow-sm relative overflow-hidden transition-all duration-200 border-2 ${
                    theme === 'dark' 
                    ? 'bg-zinc-950 border-blue-500 shadow-blue-500/10' 
                    : 'bg-zinc-800 border-transparent hover:border-zinc-700'
                  }`}
                >
                   {theme === 'dark' && <div className="absolute inset-0 bg-blue-500/10"></div>}
                   <span className={`relative text-sm font-medium ${theme === 'dark' ? 'text-white' : 'text-zinc-400'}`}>Dark Mode</span>
                </button>
                <button 
                ...
                >
                   {theme === 'light' && <div className="absolute inset-0 bg-blue-500/10"></div>}
                   <span className={`relative text-sm font-medium ${theme === 'light' ? 'text-zinc-900' : 'text-zinc-500'}`}>Light Mode</span>
                </button>
              </div>
            </div>
